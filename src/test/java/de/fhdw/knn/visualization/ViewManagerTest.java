...
//        Network network = TestUtil.simpleDummyNetwork();
//        ViewManager vm = new ViewManager(0, 0, true, false, ColorScheme.RED_GREEN, network);
...
//            Network network = TestUtil.simpleDummyNetwork();
//            ViewManager vm = new ViewManager(1, 0, true, true, ColorScheme.RED_GREEN, network);
//            assertDoesNotThrow(() -> vm.nextEpoch(1, network, 10));
//            assertDoesNotThrow(() -> vm.earlyStop(1, network));
//        });
//    }
}
